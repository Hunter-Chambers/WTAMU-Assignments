...
//Non-interactive test program for the DLinkedSequence class
//
// DESCRIPTION:
...
public class SequenceExam {
    ...
    public static final String[] DESCRIPTION = {
        "Tests for the DLinkedSequence class with dynamic array allocation",
    ...
    // **************************************************************************
    // boolean test_basic(DLinkedSequence test, int s, boolean has_cursor)
    ...
    // **************************************************************************
    public static boolean test_basic(DLinkedSequence<Long> test, int s, boolean has_cursor) {
        boolean answer;
    ...
    // **************************************************************************
    // boolean test_items(DLinkedSequence test, int s, int i, long items[])
    ...
    // **************************************************************************
    public static boolean test_items(DLinkedSequence<Long> test, int s, int i, long items[]) {
        boolean answer = true;
    ...
    // **************************************************************************
    // boolean correct(DLinkedSequence test, int s, int cursor_spot, long items[])
    //   This function determines if the sequence (test) is "correct" according to
    //   these requirements:
    //   a. it has exactly s items.
    //   b. the items (begining at the front) are equal to
    //      items[0] ... items[s-1]
    ...
    // **************************************************************************
    public static boolean correct(DLinkedSequence<Long> test, int size, int cursor_spot, long items[]) {
        ...
        // Rebegin the cursor at the front of the sequence and test items again.
        System.out.printf("%s\n", "I'll call begin() and look at the items one more time...");
        test.begin( );
    ...
    public static int test1( ) {
        DLinkedSequence<Long> empty = new DLinkedSequence<Long>();
        DLinkedSequence<Long> test = new DLinkedSequence<Long>();    // A sequence to add items to
        ...
        System.out.printf("%s\n","Then I move the cursor to the begin and addBefore 5.");
        test = new DLinkedSequence<Long>();
        ...
        System.out.printf("I am now using addAfter to put 10,20,30 in an empty sequence.\n");
        System.out.printf("Then I move the cursor to the begin, advance once, ");
        System.out.printf("%s\n","and addBefore 15.");
        test = new DLinkedSequence<Long>();
        test.addAfter(10L);
        test.addAfter(20L);
        ...
        System.out.printf("I am now using addAfter to put 10,20,30 in an empty sequence.\n");
        System.out.printf("Then I move the cursor to the begin and addAfter 15 ");
    ...
    public static int test2( ) {
        ...
        DLinkedSequence<Long> test = new DLinkedSequence<Long>();
        int i;
    ...
    public static int test3( ) {
        ...
        System.out.printf("Set the cursor to the begin and remove the 10.\n");
        test.begin( );
        test.removeCurrent( );
    ...
    public static int test4( ) {
        final int TESTSIZE = 30;
        DLinkedSequence<Long> original = new DLinkedSequence<Long>(); // A DLinkedSequence that we'll copy.
        ...
        // Test copying of an empty DLinkedSequence. After the copying, we change original.
        System.out.printf("Copy constructor test: for an empty DLinkedSequence.\n");
        DLinkedSequence<Long> copy1 = new DLinkedSequence<Long>(original);
        original.addAfter(1L); // Changes the original DLinkedSequence, but not the copy.
        //System.out.printf("Original:" + original + "\n");
        //System.out.printf("Copy:" + copy1 + "\n");;
        if (!correct(copy1, 0, 0, items)) return 0;
    
        // Test copying of a DLinkedSequence with current item at the tail.
        System.out.printf("Copy constructor test: for a DLinkedSequence with cursor at tail.\n");
        for (i=2; i <= 2*TESTSIZE; i++)
            original.addAfter((long)i);
        //System.out.printf("Original:" + original + "\n");
        DLinkedSequence<Long> copy2 = new DLinkedSequence<Long>(original);
        ...
        // Test copying of a DLinkedSequence with cursor near the middle.
        ...
        DLinkedSequence<Long> copy3= new DLinkedSequence<Long>(original);
        original.begin( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n);
        ...
        // Test copying of a DLinkedSequence with cursor at the front.
        System.out.printf("Copy constructor test: for a DLinkedSequence with cursor at front.\n");
        original.addBefore(2L);
        original.begin( );
        // Cursor is now at the front.
        DLinkedSequence<Long> copy4 = new DLinkedSequence<Long>(original);
        original.begin( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n);
        ...
        // Test copying of a DLinkedSequence with no current item.
        System.out.printf("Copy constructor test: for a DLinkedSequence with no current item.\n");
        original.addBefore(2L);
        while (original.isCurrent( ))
            original.advance( );
        // There is now no current item.
        DLinkedSequence<Long> copy5 = new DLinkedSequence<Long>(original);
        original.begin( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n");
    ...
    public static int test5( ) {
        ...
        // Test copying of an empty DLinkedSequence. After the copying, we change original.
        System.out.printf("clone test: for an empty DLinkedSequence.\n");
        DLinkedSequence<Long> copy1 = original.clone();
        original.addAfter(1L); // Changes the original DLinkedSequence, but not the copy.
        //System.out.printf("Original:" + original + "\n");
        //System.out.printf("Copy:" + copy1 + "\n");;
        if (!correct(copy1, 0, 0, items)) return 0;
        ...
        // Test copying of a DLinkedSequence with current item at the tail.
        System.out.printf("clone test: for a DLinkedSequence with cursor at tail.\n");
        for (i=2; i <= 2*TESTSIZE; i++)
            original.addAfter((long)i);
        //System.out.printf("Original:" + original + "\n");
        DLinkedSequence<Long> copy2 = original.clone();
        //System.out.printf("Copy:" + copy2 + "\n");
        original.removeCurrent( ); // Delete tail from original, but not the copy
        //System.out.printf("Original:" + original + "\n");
        original.begin( );
        ...
        for (i = 1; i < TESTSIZE; i++)
            original.advance( );
        // Cursor is now at location [TESTSIZE] (counting [0] as the first spot).
        DLinkedSequence<Long> copy3= original.clone();
        original.begin( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n);
        ...
        // Test copying of a DLinkedSequence with cursor at the front.
        System.out.printf("clone test: for a DLinkedSequence with cursor at front.\n");
        original.addBefore(2L);
        original.begin( );
        // Cursor is now at the front.
        DLinkedSequence<Long> copy4 = original.clone();
        original.begin( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n);
        ...
        // Test copying of a DLinkedSequence with no current item.
        System.out.printf("clone test: for a DLinkedSequence with no current item.\n");
        original.addBefore(2L);
        while (original.isCurrent( ))
            original.advance( );
        // There is now no current item.
        DLinkedSequence<Long> copy5 = original.clone();
        original.begin( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n");
...
// **************************************************************************
    public static int test6( ) {
        final int TESTSIZE = 30;
        DLinkedSequence<Long> testa, testi;
        testa = new DLinkedSequence<Long>();
        testi = new DLinkedSequence<Long>();
        long items[] = new long[2*TESTSIZE];
        int i;
    ...
    public static int test7( ) {
        final int TESTSIZE = 30;
        DLinkedSequence<Long> testa, testi, empty;
        testa = new DLinkedSequence<Long>();
        testi = new DLinkedSequence<Long>();
        empty = new DLinkedSequence<Long>();
    ...
    public static int test8( ) {
        final int TESTSIZE = 30;
        long items[] = new long[2*TESTSIZE];
        DLinkedSequence<Long> seq1, seq2, empty;  //each created empty with capacity of 1
        seq1 = new DLinkedSequence<Long>();
        seq2 = new DLinkedSequence<Long>();
        empty = new DLinkedSequence<Long>();
        int i;
        ...
        for (i = 1; i <= 2*TESTSIZE; i++) {
            seq1.addAfter((long)i);
            seq2.addAfter((long)i);
        }
        ...
        */
        ...
        System.out.printf("Emptying seq1, then executing seq1 = seq2.concatenation(new DLinkedSequence())\n");
        seq1 = new DLinkedSequence<Long>();
        seq1 = seq2.concatenation(new DLinkedSequence<Long>());
