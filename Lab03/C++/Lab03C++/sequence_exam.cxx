...
// **************************************************************************
// bool test_items(sequence& test, size_t s, size_t i, long items[])
...
// **************************************************************************
// bool correct(sequence& test, size_t s, size_t cursor_spot, long items[])
...
// **************************************************************************
bool correct(sequence& test, size_t size, size_t cursor_spot, long items[]) {
...
int test8( ) {
    const size_t TESTSIZE = 30;
    long items[2*TESTSIZE];
    sequence seq1, seq2, empty;  //each created empty with capacity of 1
    size_t i;
