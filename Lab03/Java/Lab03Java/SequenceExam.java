...
//Non-interactive test program for the LongArraySequence class
//
// DESCRIPTION:
...
public class SequenceExam {
    ...
    // **************************************************************************
    // boolean test_basic(LongArraySequence test, int s, boolean has_cursor)
    ...
    // **************************************************************************
    public static boolean test_basic(LongArraySequence test, int s, boolean has_cursor) {
        boolean answer;
    ...
    // **************************************************************************
    // boolean test_items(LongArraySequence test, int s, int i, long items[])
    ...
    // **************************************************************************
    public static boolean test_items(LongArraySequence test, int s, int i, long items[]) {
        boolean answer = true;
    ...
    // **************************************************************************
    // boolean correct(LongArraySequence test, int s, int cursor_spot, long items[])
    ...
    // **************************************************************************
    public static boolean correct(LongArraySequence test, int size, int cursor_spot, long items[]) {
    ...
    public static int test1( ) {
        LongArraySequence empty = new LongArraySequence();
        LongArraySequence test = new LongArraySequence();    // A sequence to add items to
    ...
    public static int test2( ) {
        ...
        LongArraySequence test = new LongArraySequence();
        int i;
    ...
    public static int test4( ) {
        final int TESTSIZE = 30;
        LongArraySequence original = new LongArraySequence(); // A LongArraySequence that we'll copy.
        ...
        // Test copying of an empty LongArraySequence. After the copying, we change original.
        System.out.printf("Copy constructor test: for an empty LongArraySequence.\n");
        LongArraySequence copy1 = new LongArraySequence(original);
        original.addAfter(1); // Changes the original LongArraySequence, but not the copy.
        ...
        System.out.printf("Copy constructor test: for a LongArraySequence with cursor at tail.\n");
        for (i=2; i <= 2*TESTSIZE; i++)
            original.addAfter(i);
        //System.out.printf("Original:" + original + "\n");
        LongArraySequence copy2 = new LongArraySequence(original);
        ...
        LongArraySequence copy3= new LongArraySequence(original);
        original.start( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n);
        ...
        System.out.printf("Copy constructor test: for a LongArraySequence with cursor at front.\n");
        original.addBefore(2);
        original.start( );
        // Cursor is now at the front.
        LongArraySequence copy4 = new LongArraySequence(original);
        original.start( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n);
        ...
        System.out.printf("Copy constructor test: for a LongArraySequence with no current item.\n");
        original.addBefore(2);
        while (original.isCurrent( ))
            original.advance( );
        // There is now no current item.
        LongArraySequence copy5 = new LongArraySequence(original);
        original.start( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n");
    ...
    public static int test5( ) {
        ...
        // Test copying of an empty LongArraySequence. After the copying, we change original.
        System.out.printf("clone test: for an empty LongArraySequence.\n");
        LongArraySequence copy1 = original.clone();
        original.addAfter(1); // Changes the original LongArraySequence, but not the copy.
        //System.out.printf("Original:" + original + "\n");
        //System.out.printf("Copy:" + copy1 + "\n");;
        if (!correct(copy1, 0, 0, items)) return 0;
        ...
        // Test copying of a LongArraySequence with current item at the tail.
        System.out.printf("clone test: for a LongArraySequence with cursor at tail.\n");
        for (i=2; i <= 2*TESTSIZE; i++)
            original.addAfter(i);
        //System.out.printf("Original:" + original + "\n");
        LongArraySequence copy2 = original.clone();
        //System.out.printf("Copy:" + copy2 + "\n");
        original.removeCurrent( ); // Delete tail from original, but not the copy
        //System.out.printf("Original:" + original + "\n");
        original.start( );
        ...
        for (i = 1; i < TESTSIZE; i++)
            original.advance( );
        // Cursor is now at location [TESTSIZE] (counting [0] as the first spot).
        LongArraySequence copy3= original.clone();
        original.start( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n);
        ...
        // Test copying of a LongArraySequence with cursor at the front.
        System.out.printf("clone test: for a LongArraySequence with cursor at front.\n");
        original.addBefore(2);
        original.start( );
        // Cursor is now at the front.
        LongArraySequence copy4 = original.clone();
        original.start( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n);
        ...
        // Test copying of a LongArraySequence with no current item.
        System.out.printf("clone test: for a LongArraySequence with no current item.\n");
        original.addBefore(2);
        while (original.isCurrent( ))
            original.advance( );
        // There is now no current item.
        LongArraySequence copy5 = original.clone();
        original.start( );
        original.advance( );
        original.removeCurrent( ); // Delete 2 from original, but not the copy.
        //System.out.printf("Original:" + original + "\n");
...
// **************************************************************************
    public static int test6( ) {
        final int TESTSIZE = 30;
        LongArraySequence testa, testi;
        testa = new LongArraySequence();
        testi = new LongArraySequence();
        long items[] = new long[2*TESTSIZE];
        int i;
    ...
    public static int test7( ) {
        final int TESTSIZE = 30;
        LongArraySequence testa, testi, empty;
        testa = new LongArraySequence();
        testi = new LongArraySequence();
        empty = new LongArraySequence();
    ...
    public static int test8( ) {
        final int TESTSIZE = 30;
        long items[] = new long[2*TESTSIZE];
        LongArraySequence seq1, seq2, empty;  //each created empty with capacity of 1
        seq1 = new LongArraySequence();
        seq2 = new LongArraySequence();
        empty = new LongArraySequence();
        int i;
        ...
        */
        ...
        System.out.printf("Emptying seq1, then executing seq1 = seq2.concatenation(new LongArraySequence())\n");
        seq1 = new LongArraySequence();
        seq1 = seq2.concatenation(new LongArraySequence());
