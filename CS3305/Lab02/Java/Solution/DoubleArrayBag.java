...
public class DoubleArrayBag implements Cloneable  {
   ...
   **/ 
   ...
   public boolean equals(Object other) {
       ...
       // STUDENT IMPLEMENTATION OF ABOVE HERE
       while (index < this.used && elementsEqual) {
           if (this.data[index] != candidate.data[index]) elementsEqual = false;
           else index++;
       }
   ...
   **/
   public int erase( double target ) {
       ...
       int i = 0;
       while (i < this.used) {
           if (this.data[i] == target) this.data[i] = this.data[--used];
           else i++;
       }
