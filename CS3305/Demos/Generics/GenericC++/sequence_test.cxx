...
typedef long Item;
typedef sequence<Item>::size_type size_type;
...
void show_sequence(const sequence<Item>& display);
...
int main( ) {
    sequence<Item> test1, test2, test3; // Sequences that we'll perform tests on
    ...
    do {
        ...
        switch (choice) {
            ...
            case 'c': if (test1.is_current( ))
                           cout << "Current item is: " << test1.is_current( ) << endl;
                      else
                          cout << "There is no current item." << endl;
                      pressEnterToContinue();
                      break;
            ...
            case 't': test1.trim_to_size();
                      break;
            case 'C': test3 = sequence<Item>(test1);
                      break;
            case 'q':
...
// Library facilities used: iostream
    ...
    cout << "\t\t C   Use copy constructor test3 = sequence<Item>(test1)" << endl;
