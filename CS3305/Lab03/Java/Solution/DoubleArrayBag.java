...
public class DoubleArrayBag implements Cloneable  {
   ...
   **/   
   ...
   public DoubleArrayBag( DoubleArrayBag source ) {
       ...
       this.data = new double[source.used]; //NOTE: only allocating needed space
   ...
   **/ 
   ...
   public void ensureCapacity( int newCapacity ) {
       ...
       if ( this.data.length < newCapacity ) {
           ...
           //   allocate a new array with capacity newCapacity
           //   copy elements from current this.data into new array
           //   make this.data reference the new array
   ...
   **/
   public void plusEquals(DoubleArrayBag addend) {
       ...
       // addend and then copy them into this bag and update any
       // attributes needing updating
    ...
    **/
    public void trimToSize( ) {
        if ( this.used < this.data.length ) {
            ...
            // STUDENT WORK GOES HERE
            //    allocate a new smaller array with newCapacity
            //    copy the elements from this.data into new array
            //    make this.data reference the new array
            double[] newData = new double[newCapacity];
            System.arraycopy(this.data, 0, newData, 0, this.used);
            this.data = newData;
   ...
   **/   
   public static DoubleArrayBag union(DoubleArrayBag b1, DoubleArrayBag b2) {
      ...
      //STUDENT WORK HERE
      int totalSize = b1.size() + b2.size();
      int unionCapacity = totalSize > 0 ? totalSize : 1;
      DoubleArrayBag newBag = new DoubleArrayBag( unionCapacity );
