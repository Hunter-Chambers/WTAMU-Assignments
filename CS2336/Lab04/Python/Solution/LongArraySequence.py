...
#           undefined.
    ...
    def copy(self) -> LongArraySequence:
        ...
        for i in range(self.__used):
            newSequence.__data[i] = self.__data[i]
        # end for

        newSequence.__used = self.__used
        newSequence.__cursor = self.__cursor
    ...
    def __eq__(self, other: LongArraySequence) -> bool:
        ...
        if (self.__used != other.__used):
            return False
        if (self.__cursor != other.__cursor):
            return False
        # end ifs

        i = 0
        while (i < self.__used and isEqual):
    ...
    def isCurrent(self) -> int:
        ...
        # class invariant
        return (self.__cursor >= 0 and self.__cursor < self.__used)
    ...
    def __add__(self, other) -> LongArraySequence:
        ...
        i = 0
        while (i < self.__used):
            newSequence.__data[newSequence.__used] = self.__data[i]
            newSequence.__used += 1
            i += 1
        # end while

        i = 0
        while (i < other.__used):
            newSequence.__data[newSequence.__used] = other.__data[i]
            newSequence.__used += 1
            i += 1
        # end while

        newSequence.__cursor = newSequence.__used
    ...
    def ensureCapacity(self, minimumCapacity: int) -> None:
        ...
        if len(self.__data) < minimumCapacity:
            ...
            for i in range(self.__used):
                biggerArray[i] = self.__data[i]
            # end for

            self.__data = biggerArray
        # end if
    # end ensureCapacity
    ...
    def trimToSize(self) -> None:
        ...
        if len(self.__data) != self.__used:
            ...
            for i in range(self.__used):
                trimmedArray[i] = self.__data[i]
            # end for

            self.__data = trimmedArray
        # end if
    # end trimToSize
    ...
    def addBefore(self, newEntry: ElementType) -> None:
        ...
        if index == 0:
            ...
            for i in range(self.__used, location - 1, -1):
                self.__data[i] = self.__data[i - 1]
            # end for

            self.__data[location] = newEntry
            self.__cursor = location
        # end if
    ...
    def addAfter(self, newEntry: ElementType) -> None:
        ...
        # end if
        location = self.__cursor + 1 if self.isCurrent() else self.__used
        index = self.__used - 1
        # STUDENT IMPLEMENTATION GOES HERE
    ...
    def removeCurrent(self) -> None:
        ...
        for i in range(self.__cursor, self.__used):
            self.__data[i] = self.__data[i + 1]
        # end for
    # end remove
