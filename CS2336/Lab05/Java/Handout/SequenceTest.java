...
public class SequenceTest {
    ...
    public static void main( String [] args ) {
        ...
        SLinkedSequence<Long> test1, test2, test3;
        test1 = new SLinkedSequence<Long>();
        test2 = new SLinkedSequence<Long>();
        test3 = new SLinkedSequence<Long>();
        ...
        do {
            ...
            switch (choice) {
                ...
                case 'e' : System.out.printf("test1.equals(test2)? %s\n", test1.equals(test2) );
                           pressEnterToContinue();
                           break;
                case 'C' : test3 = new SLinkedSequence<Long>( test1 );
                           break;
    ...
    public static void print_menu( ) {
        ...
        System.out.printf("\t\t C  Use copy constructor test3 = new SLinkedSequence<Long>(test1)\n");
        System.out.printf("\t\t i  Invoke iterator on test1\n");
    ...
    public static void showSequence( SLinkedSequence<Long> seq ) {
        System.out.printf("%s\n", seq);
    }
